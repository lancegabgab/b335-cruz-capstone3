...
export default function Home() {
  ...
  return (
    <Container className="text-center">
      {/* For Cats */}
      <div className="mt-2" style={catsSectionStyle}>
        <h1 style={{ fontFamily: 'Impact, sans-serif', fontSize: '3em', color: '#333' }}>FEATURED PRODUCTS FOR CATS</h1>
        <Row>
          {/* Card 1 */}
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5" style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              <Card.Img variant="top" src={TurnTable} alt="Cat TurnTable" />
              <Card.Body>
                <Card.Title className="text-white">Cat TurnTable</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
          ...
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5" style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              ...
              <Card.Body>
                <Card.Title className="text-white">Cat Tunnel</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
          ...
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5" style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              ...
              <Card.Body>
                <Card.Title className="text-white">Scratcher Toy</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
      ...
      <div style={dogsSectionStyle}>
        <h1 style={{ fontFamily: 'Impact, sans-serif', fontSize: '3em', color: '#333' }}>FEATURED PRODUCTS FOR DOGS</h1>
        <Row>
          {/* Card 1 */}
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5" style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              ...
              <Card.Body>
                <Card.Title className="text-white">Fetching Toy</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
          ...
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5" style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              ...
              <Card.Body>
                <Card.Title className="text-white">Bone Chew Toy</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
          ...
          <Col sm={6} md={4}>
            <Card className="bg-dark border-black border-5"style={{ borderWidth: '3px', margin: '10px', fontFamily: 'Verdana, sans-serif' }}>
              ...
              <Card.Body>
                <Card.Title className="text-white">Flirt Pole</Card.Title>
                <Card.Text className="border text-white p-2 rounded">
